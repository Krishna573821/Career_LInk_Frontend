...
export const fetchJobs =
   ...
   async (dispatch) => {
      try {
         ...
         let link =
            "https://career-link-backend-62pl.onrender.com/api/v1/job/getall?"; // Base API endpoint for fetching all jobs
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
   ...
   try {
      const response = await axios.get(
         `https://career-link-backend-62pl.onrender.com/api/v1/job/get/${jobId}`,
         { withCredentials: true }
      ); // Send the GET request for the job
...
export const postJob = (data) => async (dispatch) => {
   ...
   try {
      const response = await axios.post(
         `https://career-link-backend-62pl.onrender.com/api/v1/job/post`,
         data,
         {
            // Send the POST request to create a job
            withCredentials: true,
...
export const getMyJobs = () => async (dispatch) => {
   ...
   try {
      const response = await axios.get(`https://career-link-backend-62pl.onrender.com/api/v1/job/getmyjobs`, {
         withCredentials: true,
      }); // Send the GET request for the user's jobs
...
export const deleteJob = (id) => async (dispatch) => {
   ...
   try {
      const response = await axios.delete(`https://career-link-backend-62pl.onrender.com/api/v1/job/delete/${id}`, {
         withCredentials: true,
      }); // Send the DELETE request to remove a job
