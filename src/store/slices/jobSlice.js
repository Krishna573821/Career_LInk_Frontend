...
export const fetchJobs =
  ...
  async (dispatch) => {
    try {
      ...
      let link = "https://career-link-backend-62pl.onrender.com/api/v1/job/getall?";
      let queryParams = [];
      if (searchKeyword) {
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://career-link-backend-62pl.onrender.com/api/v1/job/getmyjobs`,
      { withCredentials: true }
    );
...
export const deleteJob = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://career-link-backend-62pl.onrender.com/api/v1/job/delete/${id}`,
      { withCredentials: true }
    );
